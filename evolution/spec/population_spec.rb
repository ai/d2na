...
describe D2NA::Population do
  ...
  it "should fill itself" do
    ...
    population.codes.should == [code, code, code, code, code]
  ...
  it "should add new code" do
    ...
    population.add(1, 1.0)
    population.add(3, 3.0)
    population.add(2, 2.0)
    population.add(1, 1.0)
    population.add(4, 4.0)
    population.add(1, 1.0)
    population.add(2, 2.0)
    
    population.codes.should == [1, 3, 2, 1, 4, 1, 2]
